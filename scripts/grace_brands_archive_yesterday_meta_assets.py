#!/usr/bin/env python3
"""
Incrementally archive yesterday's Grace Brands Meta creative assets.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Archive yesterday's Grace Brands Meta assets into latest_90d without replacing existing Drive files."
    )
...
def main() -> int:
    ...
    print(f"Incremental Grace Brands Meta asset archive for {target_date.isoformat()} -> {args.folder_name}", flush=True)
