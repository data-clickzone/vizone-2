    ...
    def do_GET(self):
        ...
        if not token or not account_id:
            json_response(self, 503, {
                ...
                "message": "Set THE_MIA_META_ACCESS_TOKEN and THE_MIA_META_AD_ACCOUNT_ID to enable Meta creative enrichment.",
                "requiredEnv": ["THE_MIA_META_ACCESS_TOKEN", "THE_MIA_META_AD_ACCOUNT_ID"],
            })
            return
